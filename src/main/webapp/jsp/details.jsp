    ...
    <div class="data-cont-wrap w1200">
        ...
        <div class="product-intro layui-clear">
            <div class="preview-wrap">
                <a href="javascript:;"><img height="400px" width="400px" src="${pageContext.request.contextPath}/res/${product.pimage}"></a>
            </div>
            <div class="itemInfo-wrap">
                <div class="itemInfo">
                    ...
                    <div class="summary">
                        <p class="reference"><span>参考价</span> <del>￥${product.marketPrice}</del></p>
                        <p class="activity"><span>活动价</span><strong class="price"><i>￥</i>${product.shopPrice}</strong></p>
                    ...
                    <div class="choose-btns">
                        ...
                        <a href='javascript:addCart()' class="layui-btn  layui-btn-danger car-btn"><i class="layui-icon layui-icon-cart-simple"></i>加入购物车</a>
                    </div>
                </div>
            </div>
        </div>
        <div class="layui-clear">
            <div class="aside">
                ...
                <div class="item-list">
                    <div class="item">
                        <img src="${pageContext.request.contextPath}/res/static/img/details_img2.jpg">
...
<script type="text/javascript">
    ...
    function  addCart() {
        ...
        //2.获取count|num
        var num = window.document.getElementById("count").value;

        //3.提交
        location.href= '${pageContext.request.contextPath}/addCart?pid='+pid+"&num="+num;
