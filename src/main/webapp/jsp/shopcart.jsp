                    ...
                    <li class="th th-item">
                        <div class="item-cont">
                            <a href="javascript:;"><img
                                    src="${pageContext.request.contextPath}/res/${cartItem.product.pimage}" alt=""></a>
                            <div class="text">
                                <div class="title">${cartItem.product.pname}</div>
                                <p><span>粉色</span> <span>130</span>cm</p>
                            </div>
                        </div>
                    </li>
                    <li class="th th-price">
                        <span class="th-su">${cartItem.product.shopPrice}</span>
                    </li>
                    <li class="th th-amount">
                        <div class="box-btn layui-clear">
                            <div class="less layui-btn">-</div>
                            <input class="Quantity-input" type="" name="" value="${cartItem.count}" disabled="disabled">
                            <div class="add layui-btn">+</div>
                        </div>
                    </li>
                    <li class="th th-sum">
                        <span class="sum">${cartItem.product.shopPrice * cartItem.count}</span>
                    </li>
                    <li class="th th-op">
